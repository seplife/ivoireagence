...
export const mockProperties: Property[] = [
  ...
  {
    id: "11",
    title: "Ferme avicole +3000 poulets équipée",
    description:
      "Ferme avicole moderne pouvant accueillir plus de 3000 poulets avec bâtiments d’élevage entièrement équipés. Comprend abreuvoirs, mangeoires, puits d’eau et maison de 2 pièces entièrement équipée. Site prêt à l’exploitation pour activité avicole intensive.",
    property_type: "Ferme avicole",
    status: "À Louer",
    price: 80000,
    surface: null,
    rooms: 2,
